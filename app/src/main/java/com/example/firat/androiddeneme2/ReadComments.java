...
public class ReadComments extends ListActivity {
    ...
    //testing on Emulator:
    private static final String READ_COMMENTS_URL = "http://192.168.1.101:80/webservis/comments.php";
    ...
    public void addComment(View v) {
        helper.goster(ReadComments.this, AddComment.class);
    }
    ...
    public void updateJSONdata() {
        ...
        JSONObject json = JSONParser.INSTANCE.getJSONFromUrl(READ_COMMENTS_URL);
    ...
    private void updateList() {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                try{
                    helper.goster(ReadComments.this,CommentDetail.class,params);
                }catch (Exception e){
                    e.printStackTrace();
                }
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = helper.showLoadingDialogBox(ReadComments.this, AlertDialog.THEME_HOLO_LIGHT, "Yorumlar Yükleniyor...", true);
            pDialog.show();
        }
